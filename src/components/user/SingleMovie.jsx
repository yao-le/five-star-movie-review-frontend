...
export default function SingleMovie() {
  ...
  const handleOnRateMovie = () => {
    // if use not logged in, redirect to sign in page
    ...
    <div className="dark:bg-primary bg-white min-h-screen pb-10">
      <Container className="xl:px-0 px-2">
        ...
        <div className="flex justify-between">
          <h1
            className="xl:text-4xl lg:text-3xl text-2xl text-highlight dark:text-highlight-dark 
        font-semibold py-3"
          >
            {title}
          </h1>
        ...
        {cast.map(({ id, profile, roleAs }) => {
          return (
            ...
            >
              ...
              <CustomButtonLink label={profile.name} clickable={false} />
